...
const Hero = () => (
  <HeroWrapper className="text-white mt-48 hero:mt-14 w-[77.7778%] mx-auto">
    ...
    <p className="max-w-[42rem] hero:max-w-xs hero:text-[12px] mb-8 hero:mb-3 text-[22px] leading-9 hero:leading-5">
    ...
    <div className="flex flex-row justify-between max-w-[36rem] paths:max-w-[284px] w-full">
      ...
      <p className="border-c-blue hover:border-c-green border-b-4 paths:border-b-2 border-solid text-[30px] leading-[37px] paths:text-[14px] paths:leading-[17px] pb-5 paths:pb-1 w-60 paths:w-[107px] text-right self-end cursor-pointer mr-5 font-medium transition ease-in-out delay-100">
        Read Articles
      </p>
    </div>
  </HeroWrapper>
